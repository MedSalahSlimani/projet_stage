...
function questionsUI() {
    ...
    return  questions.map((ques, i) => (
        ...
        <Accordion expanded={ques.open}   className={ques.open ? 'add border' : ""}>
          ...
          <input type="text" className='question-form-top-desc'placeholder='Form title' ></input>
          <div className="question-boxes">
            ...
            <AccordionDetails className="add-question">
                        ...
                        <div className="add-question-top">
                            ...
                            <Select className="select"style={{color:"#5f6368",fontSize:"13px"}} value={questions[i].questionType} >
